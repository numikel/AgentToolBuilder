...
class AgentToolBuilder():
    def __init__(self, tool_name, tool_type, tool_description, parameters = None, properties_list = None):
        self.name = tool_name
        self.type = tool_type
    ...
    def build(self, return_json = False):
        configuration = {
            "type": self.type,
            "name": self.name,
    ...
    def get_tool_parameters(self, return_json = False):
        parameters = {
            "type": "object",
